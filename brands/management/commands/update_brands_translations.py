...
class Command(BaseCommand):
    help = 'Copy default field values to _translate fields for multilingual models'
    ...
    def handle(self, *args, **options):
        ...
        model_configs = [
            (Brand_Portal, [('title', 'title_translate'), ('description', 'description_translate')]),
            (Brand_Portal_Content, [('title', 'title_translate'), ('description', 'description_translate')]),
        ]
        ...
        self.stdout.write(self.style.SUCCESS("Successfully copied values to _translate fields."))
