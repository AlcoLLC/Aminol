document.addEventListener("DOMContentLoaded", function () {
  let e = !1;
  const t = document.querySelectorAll(".mobile-dropdown");
  t.forEach((e) => {
    const o = e.querySelector(".mobile-dropdown-head"),
      n = e.querySelector("i");
    o &&
      o.addEventListener("click", function (o) {
        ...
        t.forEach((e) => {
          ...
          a ||
            ...
            n && (n.className = "fa-solid fa-chevron-up"));
      });
  });
  ...
  n &&
    (o.forEach((e) => {
      e.addEventListener("mouseenter", function () {
        ...
        e.addEventListener("mouseleave", function (t) {
          ...
          e.contains(o) || o === n || n.contains(o) || a();
        });
    }),
    ...
    o.forEach((e) => {
      const t = e.querySelector(".dropdown-head"),
  ...
  const i = document.querySelector(".language-dropdown .lang-dropdown-btn"),
    c = document.getElementById("languageDropdown"),
    ...
    l = document.getElementById("mobileLanguageDropdown"),
  ...
  function u(e) {
    let t = (function () {
      ...
      for (let e of o) {
        ...
        if ("csrftoken" === t) return o;
      }
      return null;
    })();
    const o = (function (e) {
      const t = window.location.pathname,
        o = ["az", "de", "fr", "it", "es", "pt-br", "zh-hans"];
      let n = t,
        a = "en";
      for (let e of o) {
        if (t.startsWith(`/${e}/`)) {
          (a = e), (n = t.substring(e.length + 1));
          break;
        }
        if (t === `/${e}`) {
          (a = e), (n = "{% url 'home:home' %}");
  ...
  function m() {
    ...
    document
      .querySelectorAll(".navbar a[href], .mobile-menu a[href]")
      .forEach((e) => {
        e.classList.remove("active");
      });
    document
    ...
    if (
      (t.forEach((t) => {
        ...
        if (
          n === e ||
          (n && "{% url 'home:home' %}" !== n && e.startsWith(n))
        ) {
          t.classList.add("active");
          const e = t.closest(".dropdown");
          if (e) {
            const t = e.querySelector("> a");
            t && (t.classList.add("active"), (o = !0));
          }
          const n = t.closest(".mobile-dropdown");
          if (n) {
            const e = n.querySelector(".mobile-dropdown-head");
            e && (e.classList.add("active"), (o = !0));
          }
        }
      }),
      !o)
    ...
    !(function (e) {
      ...
      if (
        ...
        const t = Array.from(document.querySelectorAll(".dropdown > a")).find(
          (e) => e.textContent.trim().toLowerCase().includes("market")
        );
        t && t.classList.add("active");
        const o = Array.from(
          document.querySelectorAll(".mobile-dropdown-head")
        ).find((e) => e.textContent.trim().toLowerCase().includes("market"));
        o && o.classList.add("active");
        const n = document.querySelector(
          `.dropdown-content a[href="${e}"], .mobile-dropdown-content a[href="${e}"]`
        );
        n && n.classList.add("active");
      }
      if (t.includes(e)) {
        const t = Array.from(document.querySelectorAll(".dropdown > a")).find(
          (e) => e.textContent.trim().toLowerCase().includes("service")
        );
        t && t.classList.add("active");
        const o = Array.from(
          document.querySelectorAll(".mobile-dropdown-head")
        ).find((e) => e.textContent.trim().toLowerCase().includes("service"));
        o && o.classList.add("active");
        const n = document.querySelector(
          `.dropdown-content a[href="${e}"], .mobile-dropdown-content a[href="${e}"]`
        );
  ...
  i &&
    ...
    r.forEach((e) => {
      e.addEventListener("click", function (e) {
        ...
        const t = this.getAttribute("data-lang");
    ...
    (function () {
      ...
      if (!t || !o)
        return void console.error(
          "HATA: Hamburger veya Mobil Menü elementi bulunamadı!"
        );
      const n = t.querySelector("i");
      let a = !1;
      t.addEventListener("click", function (e) {
        if ((e.preventDefault(), e.stopPropagation(), a)) return;
        (a = !0), console.log("Hamburger clicked");
        const i = o.classList.toggle("active");
        t.classList.toggle("active"),
          (document.body.style.overflow = i ? "hidden" : ""),
          n && (n.className = i ? "fas fa-xmark" : "fas fa-bars"),
          console.log(
    ...
    (function () {
      const e = window.location.pathname;
      let t = "en";
      const o = ["az", "de", "fr", "it", "es", "pt-br", "zh-hans"];
      for (let n of o)
        if (e.startsWith(`/${n}/`) || e === `/${n}`) {
          t = n;
          break;
        }
      document.querySelectorAll(".lang-option").forEach((e) => {
        ...
        document
          .querySelectorAll(`.lang-option[data-lang="${t}"]`)
          .forEach((e) => {
            e.classList.add("active");
          });
      const n =
      ...
      i && (i.innerHTML = `${n} <i class="fa-solid fa-angle-down"></i>`),
        s && (s.innerHTML = `${n} <i class="fa-solid fa-angle-down"></i>`);
    })(),
    m(),
    window.addEventListener("popstate", m),
    (window.updateActiveLinks = m),
