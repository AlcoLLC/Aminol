// // car Logos Carousel - Üçüncü karusel
// class carCarouselController {
//     constructor() {
//         this.gap = 115;
//         this.itemWidth = 110;
...
//         this.carousel = document.getElementById('carousel2');
//         this.content = document.getElementById('content2');
//         this.next = document.getElementById('next2');
//         this.prev = document.getElementById('prev2');

//         if (!this.carousel || !this.content || !this.next || !this.prev) {
//             console.warn('car carousel elementləri tapılmadı');
//             return;
//         }
...
//         console.log(`car Carousel: singleWidth = ${this.singleWidth}, totalItems = ${totalItems}`);
//     }
...
// // car carousel yaratma və işə salma
// let carCarouselInstance = null;

// function initCarCarousel() {
//     if (document.getElementById('carousel3')) {
//         if (carCarouselInstance) {
//             carCarouselInstance.destroy();
//         }
//         carCarouselInstance = new carCarouselController();
//     }
// }
...
//     if (carCarouselInstance) {
//         if (document.hidden) {
//             carCarouselInstance.stopAutoplay();
//         } else {
//             setTimeout(() => carCarouselInstance.startAutoplay(), 1000);
//         }
//     }
// });
...
//         setTimeout(initCarCarousel, 300);
//     });
// } else {
//     setTimeout(initCarCarousel, 300);
// }
